...
public readonly partial struct Case3 : IEquatable<Case3>
{
    ...
    /// <summary>
    /// Conversion from the Case3 to a bool
    /// </summary>
    ...
    /// <summary>
    /// Conversion from a bool to a Case3
    /// </summary>
    ...
    public static bool TryParse(bool value, out Case3 refined, [NotNullWhen(false)] out string? failureMessage)
    {
