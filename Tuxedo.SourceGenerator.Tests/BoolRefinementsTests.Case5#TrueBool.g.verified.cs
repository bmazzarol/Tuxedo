...
public readonly partial struct TrueBool : IEquatable<TrueBool>
{
    ...
    /// <summary>
    /// Conversion from the TrueBool to a bool
    /// </summary>
    ...
    /// <summary>
    /// Conversion from a bool to a TrueBool
    /// </summary>
    ...
    public static bool TryParse(bool value, out TrueBool refined, [NotNullWhen(false)] out string? failureMessage)
    {
        if (Test.True(value))
        {
